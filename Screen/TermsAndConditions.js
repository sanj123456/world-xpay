...
Unauthorised use of this website may give rise to a claim for damages and/or be a criminal offence.</Text>
            ...
            {/* <TouchableOpacity disabled={ !this.state.accepted } onPress={() => this.props.navigation.navigate('RegisterScreen')} style={ this.state.accepted ? styles.button : styles.buttonDisabled }><Text style={styles.buttonLabel}>Close</Text></TouchableOpacity> */}
      </View>
    );
  }
